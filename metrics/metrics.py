...
def average_hausdorff_distance(solution, not_dominated_solution, pareto):
    return max(
        generational_distance(solution, not_dominated_solution, pareto),
...
def pareto_dominance_indicator(solution, not_dominated_solution, all_solutions):
    return metrics_utils.pareto_dominance_indicator(
        solution, not_dominated_solution, all_solutions
    )
...
if __name__ == "__main__":
    ...
    print(
        inverse_generational_distance(my_solution, my_not_dominated_solution, my_pareto)
    )
    ...
    print(
        pareto_dominance_indicator(
            my_solution, my_not_dominated_solution, [my_solution, my_other_solution]
        )
    )
