...
algos = {'spea2': ('SPEA2', SPEA_LS, BARE_CL), 'nsga2': ('NSGAII', NSGA_LS, BARE_CL),
         'ibea': ( 'IBEA', IBEA_LS, BARE_CL),
         'imga_spea2': ('IMGA-SPEA2', SPEA_LS, IMGA_CL),
         'imga_nsga2': ( 'IMGA-NSGAII', NSGA_LS, IMGA_CL), 'imga_ibea': ('IMGA-IBEA', IBEA_LS, IMGA_CL),
         'hgs_spea2': ( 'HGS-SPEA2', SPEA_LS, HGS_CL),
         'hgs_nsga2': ( 'HGS-NSGAII', NSGA_LS, HGS_CL), 'hgs_ibea': ( 'HGS-IBEA', IBEA_LS, HGS_CL)}
...
def plot_legend(series):
    ...
    figlegend.savefig(os.path.join(PLOTS_DIR, 'plots_bnw', 'legend.pdf'))
...
def plot_results(results):
    ...
    for plot_name, plot_data in to_plot.items():
        ...
        for algo in algos_order:
            ...
            last_plt.append(plt.plot(xs, ys, ls=lines, color=color, label=name, linewidth=lw, ms=ms)[0])
