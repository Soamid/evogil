...
from evotools.stats_bootstrap import find_acceptable_result_for_budget
...
def violin(args, queue):
    ...
    for problem, metric in global_data:
        try:
            ...
            accepted_algos = [algo_name for algo_name in algos_order if
                              algo_name in algo_data and algo_data[algo_name] != [0.0] * len(algo_data[algo_name])]
            ...
            if data:
                with plt_figure():
                    ...
                    plt.xticks(x_index, [algos[algo_name][0] for algo_name in accepted_algos],
                               rotation=80)
                    for i in x_index:
                    ...
                    fig_path = PLOTS_DIR / 'plots_violin' / 'figures_violin_{}_{}.eps'.format(problem_moea, metric_short)
                    fig_path_pdf = PLOTS_DIR / 'plots_violin' / 'figures_violin_{}_{}.pdf'.format(problem_moea, metric_short)
