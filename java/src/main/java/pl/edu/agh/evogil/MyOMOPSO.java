package pl.edu.agh.evogil;//  pl.edu.agh.evogil.OMOPSO.java
//
//  Author:
...
/** Class implementing the pl.edu.agh.evogil.OMOPSO algorithm */
public class MyOMOPSO extends AbstractParticleSwarmOptimization<DoubleSolution, List<DoubleSolution>> {
    ...
    /** Constructor */
    public MyOMOPSO(DoubleProblem problem, SolutionListEvaluator evaluator, int swarmSize, int maxIterations,
    ...
    @Override public void run() {
        ...
        initProgress(); ;
        System.out.println(currentIteration + " : " + leaderArchive.size() + " : " + epsilonArchive.size());
